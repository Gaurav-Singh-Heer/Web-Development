...
function resetGame() {
    ...
    dinoImg.src = "./img/dino.png"; // Reset to running dino image
    resetBtn.style.display = "none"; // Hide reset button
    context.clearRect(0, 0, board.width, board.height); // Clear the canvas
    context.drawImage(dinoImg, dino.x, dino.y, dino.width, dino.height); // Draw the dino at the starting position
