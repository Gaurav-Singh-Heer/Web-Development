...
import cross_icon_nogb from '../Assets/Cross_nobg.png';
import circle_icon_nogb from '../Assets/Circle_nobg.png';
...
const TicTacToe = () => {
    ...
    const won = (winner)=>{
        setLock(true);
        if(winner==="o"){
            titleRef.current.innerHTML=`Congratulations: <img src=${circle_icon_nogb}>  Wins:)`
        }
        else{
            titleRef.current.innerHTML=`Congratulations: <img src=${cross_icon_nogb}>  Wins:)`
        }
    }
