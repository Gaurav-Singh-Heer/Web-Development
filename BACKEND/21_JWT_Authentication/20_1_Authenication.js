...
const {restrictToLoggedinUserOnly,checkAuth} = require('./middlewares_20/auth');

const URL=require('./models/url');

const urlRoute=require('./routes/url');
const staticRoute=require('./routes/20_1_StaticRouter');
const userRoute=require('./routes/20_1_user')
...
app.set("views", path.resolve("./20_1_Authenication_views"));
